export default {
  ...
  errors: {
    ...
    invalidRefreshToken: "Session expired. Please sign in again",
    invalidCredentials: "Wrong email or password",
    usernameTaken: "This email is already registered",
    ...
    swipeLimit: "Daily swipe limit reached. Come back tomorrow!",
    superLikeLimit: "Daily super like limit reached",
    notFound: "Not found",
    matchNotFound: "Match not found",
    profileNotFound: "Profile not found",
    alreadyExists: "Already exists",
    cannotSwipeSelf: "You can't do that with your own profile",
    alreadyMatched: "You're already matched",
    notInMatch: "Access denied",
    blockedUser: "This user is blocked",
    contentFiltered: "Message contains inappropriate language",
    internalError: "Something went wrong. Please try again",
    dbError: "Server is temporarily unavailable. Retrying...",
